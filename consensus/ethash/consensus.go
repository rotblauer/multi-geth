...
var (
	...
	EIP649FBlockReward       = big.NewInt(2e+17)                                   // Block reward in wei for successfully mining a block upward from Byzantium
	EIP1234FBlockReward      = big.NewInt(1e+17)                                   // Block reward in wei for successfully mining a block upward from Constantinople
